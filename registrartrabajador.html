				...
				<ul class="nav">
					...
					<li class="nav-item">
						...
						<ul class="nav-sub">
							...
							<li class="nav-sub-item">
								<a class="nav-sub-link" href="nacionalidad.html">NACIONALIDAD</a>
							</li>
							<li class="nav-sub-item">
					...
					<li class="nav-item">
						...
						<ul class="nav-sub">
							...
							<li class="nav-sub-item">
								<a class="nav-sub-link" href="centrocosto.html">Registro de SubCentro de Costo</a>
							</li>
						</ul>
					</li>
					<li class="nav-item">
									...
									<form action="" class="needs-validation was-validated">
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">DNI:</label>
													<input class="form-control" placeholder="DNI" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
											...
											<div class="col-lg-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" placeholder="Apellido Paterno" required="" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Segundo Apellido:</label>
													<input class="form-control" placeholder="Apellido Materno" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Fecha de Nacimiento:</label>
													<input class="form-control" placeholder="Fecha de Nacimiento" required="" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" placeholder="Calle" required="" type="text" value="">
												</div>
											</div>
										...
										<div class="col-md-12 mt-3 text-right">
											<a href="empresas.html" class="btn btn-danger btn-md"> <i class="fa fa-close"></i> Volver</a>
