...
class Controller
{
    ...
    public function listarafp()
    {
        ...
        while ($rs = mysqli_fetch_array($result)) {
            ...
            $codigoPrevired = $rs['codigoprevired'];
            $nombre = $rs['nombre'];
            $afp = new Afp($id, $codigo, $codigoPrevired, $nombre);
            $lista[] = $afp;
        }
        $this->desconectar();
        return $lista;
    ...
    public function listarisapre()
    {
        ...
        while ($rs = mysqli_fetch_array($result)) {
            ...
            $codigoPrevired = $rs['codigoprevired'];
            $nombre = $rs['nombre'];
            $isapre = new ISAPRES($id, $codigo, $codigoPrevired, $nombre);
            $lista[] = $isapre;
        }
        $this->desconectar();
        return $lista;
...
//Update Information in Database
    ...
    //Actualizar Comuna
    public function actualizarcomuna($id, $codigo, $codigoPrevired, $nombre, $region)
    {
        $this->conexion();
        $sql = "update comunas set codigo='$codigo', codigoprevired='$codigoPrevired', nombre='$nombre', region='$region' where id='$id'";
        $this->mi->query($sql);
        $this->desconectar();
    }

    //Actualizar Ciudades
    public function actualizarciudad($id, $codigo, $codigoPrevired, $nombre, $comuna)
    {
        $this->conexion();
        $sql = "update ciudades set codigo='$codigo', codigoprevired='$codigoPrevired', nombre='$nombre', comuna='$comuna' where id='$id'";
        $this->mi->query($sql);
        $this->desconectar();
    }
    ...
    //Actualizar isapre
    public function actualizarisapre($id, $codigo, $codigoPrevired, $nombre, $tasa)
    {
        $this->conexion();
        $sql = "update isapre set codigo='$codigo', codigoprevired='$codigoPrevired', nombre='$nombre', tasa='$tasa' where id='$id'";
        $this->mi->query($sql);
        $this->desconectar();
    }
    ...
    public function actualizarcajacompensacion($id, $codigo, $codigoPrevired, $nombre, $tasa)
    {
        $this->conexion();
        $sql = "update cajascompensacion set codigo='$codigo', codigoprevired='$codigoPrevired', nombre='$nombre', tasa='$tasa' where id='$id'";
        $this->mi->query($sql);
        $this->desconectar();
    }

    //Actualizar Mutual
    public function actualizarmutual($id, $codigo, $codigoPrevired, $nombre, $tasa)
    {
        $this->conexion();
        $sql = "update mutuales set codigo='$codigo', codigoprevired='$codigoPrevired', nombre='$nombre', tasa='$tasa' where id='$id'";
        $this->mi->query($sql);
        $this->desconectar();
    }

    //Actualizar Tramos Asignacion Familiar
    public function actualizartromosasignacionfamiliar($id, $codigo, $codigoPrevired, $nombre, $monto)
    {
        $this->conexion();
        $sql = "update tramosasignacionfamiliar set codigo='$codigo', codigoprevired='$codigoPrevired', nombre='$nombre', monto='$monto' where id='$id'";
        $this->mi->query($sql);
        $this->desconectar();
    }
    ...
    public function eliminarcomuna($id)
    {
       ...
       //Eliminar Isapre
        public function eliminarisapre($id){
                  $this->conexion();
                  $sql = "delete from isapres where id = $id";
                  $result = $this->mi->query($sql);
                  $this->desconectar();
                  return json_encode($result);
        }
